...
reg add %Keyboard%  /f /v "LayerDriver JPN"             /t REG_SZ     /d "kbd101.dll"
reg add %Keyboard%  /f /v "LayerDriver KOR"             /t REG_SZ     /d "kbd101a.dll"
reg add %Keyboard%  /f /v "OverrideKeyboardIdentifier"  /t REG_SZ     /d "PCAT_101KEY"
reg add %Keyboard%  /f /v "OverrideKeyboardType"        /t REG_DWORD  /d 0x00000007
reg add %Keyboard%  /f /v "OverrideKeyboardSubtype"     /t REG_DWORD  /d 0x00000000
