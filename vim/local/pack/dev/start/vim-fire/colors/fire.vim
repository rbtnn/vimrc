...
let s:base_bg = s:color('gray', 0.02)
let s:vim_border = s:color('gray', 0.07)
...
call s:high('StatusLine',       s:vim_border,         s:vim_border)
call s:high('StatusLineNC',     s:vim_border,         s:vim_border)
call s:high('StatusLineTerm',   s:vim_border,         s:vim_border)
