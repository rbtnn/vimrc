if has('vim_starting')
    ...
    autocmd vimrc-plugins ColorScheme      *
        ...
        \ | highlight!       TabSideBarNerdFont       guifg=#a6e22e guibg=#121215 gui=NONE cterm=NONE
        ...
        \ | highlight!       TabSideBarCurrNerdFont   guifg=#a6e22e guibg=#222225 gui=NONE cterm=NONE
